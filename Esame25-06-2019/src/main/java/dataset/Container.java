...
/**
 * Questa e' la classe delle funzioni per controllare se il valore di una variabile esterna e' contenuto in uno dei campi.
 * @author Matteo Ferretti (s1083630@studenti.univpm.it), Angelo D'Agostino Bonomi (s1082444@studenti.univpm.it)
 * @version 1.0
 */
/**
 * E' la classe delle funzioni per controllare se il valore di una variabile esterna e' contenuto in un determinato campo.
 * Questa classe estende {@link Lista} perche' avevamo bisogno che appunto Lista ereditasse tali metodi.
 */
public class Container extends Lista {
	...
	/**
	 * Controlla se la variabile corrente della colonna Fid nella linea i e' uguale a e.
	 * @param e Variabile da importare.
	 * @param i Numero della riga.
	 * @return true Se l'elemento i-esimo e' uguale a e, false se e' il contrario.
	 */
	...
	/**
	 * Controlla se la variabile corrente della colonna PreNorm nella linea i e' uguale a e.
	 * @param e Variabile da importare.
	 * @param i Numero della riga.
	 * @return true Se l'elemento i-esimo e' uguale a e, false se e' il contrario.
	 */
	...
	/**
	 * Controlla se la variabile corrente della colonna Provincia nella linea i e' uguale a e.
	 * @param e Variabile da importare.
	 * @param i Numero della riga.
	 * @return true Se l'elemento i-esimo e' uguale a e, false se e' il contrario.
	 */
	...
	/**
	 * Controlla se la variabile corrente della colonna Indirizzo nella linea i e' uguale a e.
	 * @param e Variabile da importare.
	 * @param i Numero della riga.
	 * @return true Se l'elemento i-esimo e' uguale a e, false se e' il contrario.
	 */
	...
	/**
	 * Controlla se la variabile corrente della colonna Telefono nella linea i e' uguale a e.
	 * @param e Variabile da importare.
	 * @param i Numero della riga.
	 * @return true Se l'elemento i-esimo e' uguale a e, false se e' il contrario.
	 */
	...
	/**
	 * Controlla se la variabile corrente della colonna Fax nella linea i e' uguale a e.
	 * @param e Variabile da importare.
	 * @param i Numero della riga.
	 * @return true Se l'elemento i-esimo e' uguale a e, false se e' il contrario.
	 */
	...
	/**
	 * Controlla se la variabile corrente della colonna Tipo nella linea i e' uguale a e.
	 * @param e Variabile da importare.
	 * @param i Numero della riga.
	 * @return true Se l'elemento i-esimo e' uguale a e, false se e' il contrario.
	 */
	...
	/**
	 * Controlla se la variabile corrente della colonna Punto nella linea i e' uguale a e.
	 * @param e Variabile da importare.
	 * @param i Numero della riga.
	 * @return true Se l'elemento i-esimo e' uguale a e, false se e' il contrario.
	 */
